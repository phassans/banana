...
func (r addBusinessAddressEndpoint) Execute(ctx context.Context, rtr *router, requestI interface{}) (interface{}, error) {
	...
	err := rtr.engine.AddBusinessAddress(request.Line1, request.Line2, request.City, request.PostalCode, request.State, request.Country, request.BusinessName, request.OtherDetails)
